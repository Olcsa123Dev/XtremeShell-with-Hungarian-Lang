...
write-host "`nAz edge el lesz távolítva."
write-host "`nFIGYELMEZTETÉS: Ha ezt elfogadod nem fogod tudni telepíteni az edge-t amíg újra nem telepíted a géped!"
$uconfirmation = Read-Host "`nTovább? [Y/N]"
if ($uconfirmation -ne "Y") { exit }
$host.ui.RawUI.WindowTitle = 'XtremeShell Edge Törlő Szkript '
## targets
...
write-host -nonew -fore green -back black "`n EDGE TÖRÖLVE!"; 
exit
